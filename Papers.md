...
8. [RAC: Efficient LLM Factuality Correction with Retrieval Augmentation](https://aclanthology.org/2025.findings-emnlp.1370.pdf)
Very similar to our project idea, using embedding to match and correct.

---
The summary that I have given for each paper may not be accurate, i have not fully read through each and every one of them so make sure to do so before doing anything with these papers.